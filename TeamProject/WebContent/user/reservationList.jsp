...
function filter(rStatus){
	...
	document.getElementById('rStatus_'+rStatus).style.display='none';
...
<div class="w3-bar w3-green">
  <a href="javascript:filter(3);" class="w3-bar-item w3-hover-white w3-padding">전체보기</a>
...
<div class="w3-row w3-border-top w3-border-bottom" id="rStatus_${rList.rStatus}" style="margin: 10px auto;">
